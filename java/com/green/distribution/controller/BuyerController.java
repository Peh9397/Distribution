...
public class BuyerController {
	...
	public String autoCompleteCdString(@RequestParam(name="category") String autoCompleteCd) throws ParseException {
		String code1 = "";
		String code2 = "";
	...
	public String buyerSearch(Model model, @RequestParam(name="keyword") String keyword) {
		...
		try {
			...
			buyer.setSortStateDate(sortStateDate);
	...
	public void orderExcelDown(HttpServletResponse response, @RequestParam(name = "items") String items)
		...
		for (Buyer bl : list) {
			...
			if (bl.getStatedate() != null) {
				...
				cell.setCellValue(bl.getStatedate());
			}
